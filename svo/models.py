...
class Subsession(BaseSubsession):
    ...
    def creating_session(self):
        ...
        if self.select_items == 'FULL':
            print(f"DEBUG: select_items = {self.select_items}")
...
class Group(BaseGroup):
    ...
    def ring_payoff(self, sender_player, receiver_player):
        sender_player.participant.dictator_payoff = 0
        receiver_player.participant.recipient_payoff = 0
        if self.subsession.random_payoff == 'SUM':
            # sum of the amount received from the sender player (slider 1 to 6)
            receiver_player.participant.recipient_payoff += sender_player.input_other_1 + sender_player.input_other_2 + \
            ...
            sender_player.participant.dictator_payoff += sender_player.input_self_1 + sender_player.input_self_2 + \
        ...
        if self.subsession.select_items == 'PRIMARY':
            ...
            if self.subsession.random_payoff == 'RAND':
                ...
                if rand == 0:
                    ...
                    receiver_player.participant.recipient_payoff += sender_player.input_other_1
                    sender_player.participant.dictator_payoff += sender_player.input_self_1
                elif rand == 1:
                    sender_player.kept_of_sender = sender_player.input_self_2
                    receiver_player.received_from_sender = sender_player.input_other_2

                    receiver_player.participant.recipient_payoff += sender_player.input_other_2
                    sender_player.participant.dictator_payoff += sender_player.input_self_2
                elif rand == 2:
                    sender_player.kept_of_sender = sender_player.input_self_3
                    receiver_player.received_from_sender = sender_player.input_other_3

                    receiver_player.participant.recipient_payoff += sender_player.input_other_3
                    sender_player.participant.dictator_payoff += sender_player.input_self_3
                elif rand == 3:
                    sender_player.kept_of_sender = sender_player.input_self_4
                    receiver_player.received_from_sender = sender_player.input_other_4

                    receiver_player.participant.recipient_payoff += sender_player.input_other_4
                    sender_player.participant.dictator_payoff += sender_player.input_self_4
                elif rand == 4:
                    sender_player.kept_of_sender = sender_player.input_self_5
                    receiver_player.received_from_sender = sender_player.input_other_5

                    receiver_player.participant.recipient_payoff += sender_player.input_other_5
                    sender_player.participant.dictator_payoff += sender_player.input_self_5
                elif rand == 5:
                    sender_player.kept_of_sender = sender_player.input_self_6
                    receiver_player.received_from_sender = sender_player.input_other_6

                    receiver_player.participant.recipient_payoff += sender_player.input_other_6
                    sender_player.participant.dictator_payoff += sender_player.input_self_6

                # receiver_player.participant.recipient_payoff *= Constants.scale # scaling the payoff
        ...
        # Case we will consider all the items
            ...
            if self.subsession.random_payoff == 'RAND':
                ...
                if rand == 0:
                    ...
                    receiver_player.participant.recipient_payoff += sender_player.input_other_7
                    sender_player.participant.dictator_payoff += sender_player.input_self_7
                elif rand == 7:
                    sender_player.kept_of_sender = sender_player.input_self_8
                    receiver_player.received_from_sender = sender_player.input_other_8

                    receiver_player.participant.recipient_payoff += sender_player.input_other_8
                    sender_player.participant.dictator_payoff += sender_player.input_self_8
                elif rand == 8:
                    sender_player.kept_of_sender = sender_player.input_self_9
                    receiver_player.received_from_sender = sender_player.input_other_9

                    receiver_player.participant.recipient_payoff += sender_player.input_other_9
                    sender_player.participant.dictator_payoff += sender_player.input_self_9
                elif rand == 9:
                    ...
                    receiver_player.participant.recipient_payoff += sender_player.input_other_10
                    sender_player.participant.dictator_payoff += sender_player.input_self_10
                elif rand == 10:
                    ...
                    receiver_player.participant.recipient_payoff += sender_player.input_other_11
                    sender_player.participant.dictator_payoff += sender_player.input_self_11
                elif rand == 11:
                    ...
                    receiver_player.participant.recipient_payoff += sender_player.input_other_12
                    sender_player.participant.dictator_payoff += sender_player.input_self_12
                elif rand == 12:
                    ...
                    receiver_player.participant.recipient_payoff += sender_player.input_other_13
                    sender_player.participant.dictator_payoff += sender_player.input_self_13
                elif rand == 13:
                    ...
                    receiver_player.participant.recipient_payoff += sender_player.input_other_14
                    sender_player.participant.dictator_payoff += sender_player.input_self_14
                elif rand == 14:
                    ...
                    sender_player.participant.recipient_payoff += sender_player.input_other_15
                    sender_player.participant.dictator_payoff += sender_player.input_self_15
                ...
                receiver_player.participant.recipient_payoff += sum(sender_other)
                receiver_player.received_from_sender += sum(sender_other)

                sender_player.participant.dictator_payoff += sum(sender_self)
    ...
    def random_dictator_payoff(self, sender_player, receiver_player):
        ...
        if self.subsession.select_items == 'PRIMARY':
            ...
            if self.subsession.random_payoff == 'RAND':
                ...
                receiver_player.received_from_sender = receiver_player.participant.recipient_payoff
                sender_player.kept_of_sender = sender_player.participant.dictator_payoff
            ...
            if self.subsession.random_payoff == 'RAND':
                ...
                if rand == 0:
                    ...
                    receiver_player.participant.recipient_payoff = sender_player.input_other_15
                    # sender payoff
                    sender_player.participant.dictator_payoff = sender_player.input_self_15
                ...
                # receiver_player.participant.recipient_payoff *= Constants.scale                      # scaling the payoff
                # sender_player.participant.dictator_payoff *= Constants.scale
...
class Player(BasePlayer):
    ...
    input_self_1 = models.FloatField(max_digits=5, decimal_places=2)
    input_other_1 = models.FloatField(max_digits=5, decimal_places=2)

    # Same as above but for item 2 in the paper
    input_self_2 = models.FloatField(max_digits=5, decimal_places=2)
    input_other_2 = models.FloatField(max_digits=5, decimal_places=2)

    # Same as above but for item 3 in the paper
    input_self_3 = models.FloatField(max_digits=5, decimal_places=2)
    input_other_3 = models.FloatField(max_digits=5, decimal_places=2)

    # Same as above but for item 2 in the paper and so on.
    input_self_4 = models.FloatField(max_digits=5, decimal_places=2)
    input_other_4 = models.FloatField(max_digits=5, decimal_places=2)

    input_self_5 = models.FloatField(max_digits=5, decimal_places=2)
    input_other_5 = models.FloatField(max_digits=5, decimal_places=2)

    input_self_6 = models.FloatField(max_digits=5, decimal_places=2)
    input_other_6 = models.FloatField(max_digits=5, decimal_places=2)

    input_self_7 = models.FloatField(max_digits=5, decimal_places=2)
    input_other_7 = models.FloatField(max_digits=5, decimal_places=2)

    input_self_8 = models.FloatField(max_digits=5, decimal_places=2)
    input_other_8 = models.FloatField(max_digits=5, decimal_places=2)

    input_self_9 = models.FloatField(max_digits=5, decimal_places=2)
    input_other_9 = models.FloatField(max_digits=5, decimal_places=2)

    input_self_10 = models.FloatField(max_digits=5, decimal_places=2)
    input_other_10 = models.FloatField(max_digits=5, decimal_places=2)

    input_self_11 = models.FloatField(max_digits=5, decimal_places=2)
    input_other_11 = models.FloatField(max_digits=5, decimal_places=2)

    input_self_12 = models.FloatField(max_digits=5, decimal_places=2)
    input_other_12 = models.FloatField(max_digits=5, decimal_places=2)

    input_self_13 = models.FloatField(max_digits=5, decimal_places=2)
    input_other_13 = models.FloatField(max_digits=5, decimal_places=2)

    input_self_14 = models.FloatField(max_digits=5, decimal_places=2)
    input_other_14 = models.FloatField(max_digits=5, decimal_places=2)

    input_self_15 = models.FloatField(max_digits=5, decimal_places=2)
    input_other_15 = models.FloatField(max_digits=5, decimal_places=2)
    ...
    svo_angle = models.FloatField(max_digits=10, decimal_places=5)
    alpha = models.FloatField(max_digits=10, decimal_places=5)
    svo_type = models.StringField(choices=['Altruist', 'Prosocial', 'Individualist', 'Competitive'])
    inequality_aversion_score = models.FloatField(max_digits=7, decimal_places=2)
    ...
    kept_of_sender = models.FloatField(max_digits=5, decimal_places=2)

    # amount received from the sender
    received_from_sender = models.FloatField(max_digits=5, decimal_places=2)
